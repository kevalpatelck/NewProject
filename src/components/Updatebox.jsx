...
//         `https://cricket-box-booking.onrender.com/api/admin/${turf._id}`,
//         formData,
//         {
//           headers: {
...
function UpdateBox() {
  ...
  const [formData, setFormData] = useState({
    ...
    time: turf?.time || "",
    image: null,
    imagePreview: turf ? `https://cricket-box-booking.onrender.com/${turf.image}` : "",
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        await axios.put(`https://cricket-box-booking.onrender.com/api/admin/update-turf/${turf._id}`, formDataToSend, {
            headers: {
