...
//     try {
//       const response = await axios.get("https://cricket-box-booking.onrender.com/api/admin/totalBookings");
...
//     try {
//       const response = await axios.get("https://cricket-box-booking.onrender.com/api/admin/totalTurfs");
