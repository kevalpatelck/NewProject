...
export default function AdminPanel() {
  ...
  //   try {
  //     const response = await fetch('https://cricket-box-booking.onrender.com/api/admin/login', {
  //       method: 'POST',
  ...
  const handleLogin = async (e) => {
    ...
    try {
        // Attempt Super Admin Login First
        let response = await axios.post('https://cricket-box-booking.onrender.com/api/superAdmin/login', { email, password });
        ...
        return; // Exit function if Super Admin login is successful

    } catch (superAdminError) {
        // If Super Admin login fails, attempt Admin login
        try {
            let response = await axios.post('https://cricket-box-booking.onrender.com/api/admin/login', { email, password });
            ...
            setErrorMessage(adminError.response?.data?.message || adminError.message);
            toast.error("❌ Login Failed! Please check your credentials.", {
                position: "top-right",
                autoClose: 3000,
                hideProgressBar: false,
...
//         const response = await axios.post("https://cricket-box-booking.onrender.com/api/admin/login", {
//             email,
//             password,
//         });
